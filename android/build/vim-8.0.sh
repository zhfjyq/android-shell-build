...
source env.sh
source common.sh
export CFLAGS="$CFLAGS -I$MEDIR/../$DISTBIN/ncurses-5.9/include -I$MEDIR/../$DISTBIN/ncurses-5.9/include/ncurses $PIEFLAG"
export CXXFLAGS="$CXXFLAGS -I$MEDIR/../$DISTBIN/ncurses-5.9/include -I$MEDIR/../$DISTBIN/ncurses-5.9/include/ncurses $PIEFLAG"
export LDFLAGS="$LDFLAGS -L$MEDIR/../$DISTBIN/ncurses-5.9/lib -rdynamic $PIEFLAG"
