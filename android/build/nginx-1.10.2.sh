...
echo Notice: require openssl-1.0.1p, pcre-8.37, zlib-1.2.11 compiled
sleep 2
...
cd ..
# rm -rf $ME
fetch_source $SRCTARBALL/$ME.tar.gz http://nginx.org/download/nginx-1.10.2.tar.gz
...
sed -i '' "s|^PIE=.*$|PIE = -fPIE -pie|" objs/Makefile
